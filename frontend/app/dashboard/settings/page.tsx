        ...
        <section className="bg-[var(--bg-card)] rounded-xl border border-[var(--border)] overflow-hidden">
          ...
          <div className="p-6 space-y-6">
            <div className="flex items-center justify-between">
              ...
              <select className="bg-[var(--bg-primary)] border border-[var(--border)] text-[var(--text-primary)] text-sm rounded-lg focus:ring-[var(--accent)] focus:border-[var(--accent)] block p-2.5 outline-none">
            ...
            <div className="space-y-3">
              ...
              <div className="flex justify-end">
                <button className="px-4 py-2 text-sm font-medium text-white bg-[var(--text-primary)] hover:bg-[var(--accent)] rounded-lg transition-colors">
                  Save Changes
                </button>
              </div>
            </div>
